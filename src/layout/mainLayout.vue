  ...
  >
    ...
    <header class="sticky top-0 z-20 bg-white/70 backdrop-blur border-b border-gray-200">
      <div class="w-full mx-auto px-4 py-3 flex items-center justify-between gap-6">
        <RouterLink
          to="/"
          class="hidden md:block items-center gap-2 font-bold text-lg hover:text-[#0A66C2] transition-colors cursor-pointer"
        >
          <span>فرصة الي</span>
        </RouterLink>
        <div class="md:hidden flex items-center justify-between w-full">
          ...
          <RouterLink
            to="/"
            class="items-center gap-2 font-bold text-lg hover:text-[#0A66C2] transition-colors cursor-pointer"
          >
            <span>فرصة الي</span>
          </RouterLink>
          <div class="w-10"></div>
        ...
        <nav class="hidden md:flex items-center gap-8 text-sm">
          <RouterLink
            ...
            :key="item.path"
            :to="item.path"
            class="relative flex flex-row gap-2 group hover:text-[#0A66C2] transition-colors cursor-pointer"
        ...
        <div class="flex items-center gap-3">
          <div class="relative" data-dropdown="notifications">
            ...
            >
              <div class="relative">
                <span class="text-xl group-hover:scale-110 transition-transform duration-300">
                  <Icon icon="solar:bell-linear" class="text-2xl" />
                </span>
                <span
                  v-if="notifications.length > 0"
                  class="absolute -top-1 -right-1 h-4 w-4 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs rounded-full flex items-center justify-center animate-pulse shadow-lg"
                >
            ...
            >
              ...
              >
                <div
                  class="p-5 border-b border-gray-100/50 bg-gradient-to-r from-gray-50/50 to-white/50"
                >
                ...
                <div class="max-h-[400px] overflow-y-auto custom-scrollbar">
                  ...
                  >
                    <div class="flex items-start gap-4">
                      <div class="relative">
                        <div
                          class="w-3 h-3 bg-gradient-to-r from-[#0A66C2] to-blue-500 rounded-full mt-2 flex-shrink-0 animate-pulse"
                        ></div>
                        <div
                          class="absolute inset-0 w-3 h-3 bg-[#0A66C2]/20 rounded-full animate-ping"
                        ></div>
                      </div>
                      <div class="flex-1 min-w-0">
                        <p
                          class="text-sm text-gray-900 leading-relaxed group-hover:text-[#0A66C2] transition-colors"
                        >
                          {{ notification.text }}
                        </p>
                        <div class="flex items-center gap-2 mt-2">
                          ...
                          <span
                            class="text-xs text-[#0A66C2] opacity-0 group-hover:opacity-100 transition-opacity"
                          >
                            عرض التفاصيل →
                          </span>
                        </div>
                ...
                <div
                  class="p-4 border-t border-gray-100/50 bg-gradient-to-r from-gray-50/30 to-white/30"
                >
                  <RouterLink
                    to="/notifications"
          ...
          <div class="relative" data-dropdown="messages">
            ...
            >
              <div class="relative">
                <span class="text-xl group-hover:scale-110 transition-transform duration-300">
                  <Icon icon="material-symbols-light:comment-outline-rounded" class="text-3xl" />
                </span>
                <span
                    ...
                    <div class="flex items-center gap-4">
                      ...
                      <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between mb-1">
                          <h4
                            class="font-semibold text-sm text-gray-900 truncate group-hover:text-[#0A66C2] transition-colors"
                          >
                            {{ message.name }}
                          </h4>
      ...
      >
        ...
        >
          <div
            class="relative p-6 border-b border-gray-100 bg-gradient-to-br from-gray-50 to-white"
          >
            <div class="flex items-center justify-between mb-6">
              <div class="flex items-center gap-4">
                <div class="relative">
                  <div
                    class="w-12 h-12 bg-gradient-to-br from-[#0A66C2] via-blue-600 to-blue-700 rounded-2xl flex items-center justify-center shadow-xl shadow-[#0A66C2]/25"
                  >
                    <span class="text-white text-xl font-bold">ف</span>
                  </div>
                  <div
                    class="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full border-2 border-white shadow-lg animate-pulse"
                  ></div>
                </div>
                <div>
              ...
              >
                <div class="w-6 h-6 flex flex-col justify-center items-center">
                  <span
                    class="block w-5 h-0.5 bg-current transition-all duration-300 group-hover:rotate-45 group-hover:bg-red-500"
                  ></span>
                  <span
                    class="block w-5 h-0.5 bg-current mt-1 transition-all duration-300 group-hover:-rotate-45 group-hover:-translate-y-1 group-hover:bg-red-500"
                  ></span>
                </div>
              </button>
            </div>
            <div class="grid grid-cols-3 gap-4">
              <div
                class="text-center p-4 bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 group cursor-pointer"
              >
                <div
                  class="text-xl font-bold text-[#0A66C2] group-hover:scale-110 transition-transform"
                >
                  {{ notifications.length }}
                </div>
          ...
          <nav class="p-4 space-y-4">
            ...
            >
              ...
              <div class="relative z-10">
                <div
                  class="w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-300 group-hover:scale-110"
                  :class="
                    isActiveRoute(item.path)
              ...
              <div class="flex-1 z-10">
                ...
                <div
                  ...
                  :class="isActiveRoute(item.path) ? 'text-white/80' : 'text-gray-500'"
                >
          ...
          <div class="p-4 border-t border-gray-100 bg-gray-50">
            <div
              class="flex items-center gap-4 p-5 rounded-3xl bg-white border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer"
            >
              <div class="relative">
                <img
                ...
                />
                <div
                  class="absolute -bottom-2 -right-2 w-6 h-6 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full border-3 border-white shadow-xl animate-pulse"
                ></div>
              </div>
              <div class="flex-1">
                ...
                <div class="flex items-center gap-3 mt-2">
                  <span
                    class="text-xs text-[#0A66C2] font-semibold bg-[#0A66C2]/10 px-2 py-1 rounded-full"
                    >عضو منذ 2023</span
                  >
            ...
            <div class="mt-6 space-y-3">
              ...
              >
                <div
                  class="w-10 h-10 bg-gradient-to-r from-blue-500 to-[#0A66C2] rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow"
                >
                  <span class="text-white text-lg group-hover:scale-110 transition-transform"
                    >👤</span
                  >
                </div>
                <span class="flex-1 font-medium">الملف الشخصي</span>
                <span
                  class="text-gray-400 group-hover:text-[#0A66C2] transition-colors opacity-0 group-hover:opacity-100"
                  >→</span
                >
              </RouterLink>
              <RouterLink
              ...
              >
                <div
                  class="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow"
                >
                  <span class="text-white text-lg group-hover:scale-110 transition-transform"
                    >⚙️</span
                  >
              ...
              >
                <div
                  class="w-10 h-10 bg-gradient-to-r from-orange-500 to-yellow-500 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow"
                >
                  <span class="text-white text-lg group-hover:scale-110 transition-transform"
                    >❓</span
                  >
              ...
              >
                <div
                  class="w-10 h-10 bg-gradient-to-r from-red-500 to-pink-500 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow"
                >
                  <span class="text-white text-lg group-hover:scale-110 transition-transform"
                    >🚪</span
                  >
                ...
                <span
                  class="text-red-400 group-hover:text-red-600 transition-colors opacity-0 group-hover:opacity-100"
                  >→</span
                >
              </button>
            </div>
      ...
      <div class="h-1 w-full rounded-b-lg overflow-hidden">
        <div class="h-full w-full bg-gradient-to-r from-red-500 via-white to-black relative">
          <div
            class="absolute inset-0 bg-gradient-to-r from-transparent via-yellow-300/20 to-transparent animate-pulse"
          ></div>
        </div>
      </div>
    </header>
    <main class="transition-all duration-500" :class="{ 'blur-sm md:blur-none': showMobileMenu }">
      <slot />
    </main>
...
const navigationItems = ref([
  { path: '/', label: 'الرئيسية', icon: 'lucide:home', badge: 0 },
  { path: '/my-network', label: 'شبكتي', icon: 'mage:users', badge: 3 },
  { path: '/jobs', label: 'وظايف', icon: 'ph:suitcase', badge: 0 },
  { path: '/messages', label: 'الرسائل', icon: 'mdi-light:message-text', badge: 2 },
  { path: '/notifications', label: 'الإشعارات', icon: 'solar:bell-linear', badge: 5 },
  { path: '/profile', label: 'الملف الشخصي', icon: 'iconamoon:profile-light', badge: 0 },
])
